...
def full_network(params):
    ...
    # params for control
    ctrl_dim = params['ctrl_dim']
    u = tf.placeholder(tf.float32, shape=[None, ctrl_dim], name='u')
    ...
    if model_order == 1:
        ...
        Theta = sindy_library_tf(zu, latent_dim + ctrl_dim, poly_order, include_sine)
    else:
    ...
    if params['sequential_thresholding']:
        ...
        sindy_predict = tf.matmul(Theta, coefficient_mask*sindy_coefficients) # prediction of dz
