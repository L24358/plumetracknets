...
def load_plume(
    ...
    puff_filename = spt.navigator.file_pointer("puff_data_{dataset}.pkl", dataset)
    wind_filename = spt.navigator.file_pointer("wind_data_{dataset}.pkl", dataset)
